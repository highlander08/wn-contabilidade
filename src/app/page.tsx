  ...
  const slides = [
    {
      ...
      subtitle: "Tenha um Endereço Fiscal confiável e evite dores de cabeça com burocracias",
...
Gostaria de receber mais informações!`
  ...
  const services = [
    {
      ...
      description: "Endereço comercial estratégico para registro de CNPJ com toda documentação regularizada.",
      features: ["IPTU Comercial", "Alvará de funcionamento", "Certificado de conformidade", "Licença Sanitária"],
      color: "from-blue-500 to-cyan-500"
    },
    {
      icon: "fas fa-certificate",
      title: "Certificado Digital",
      description: "Identidade eletrônica para assinar documentos à distância com valor jurídico.",
      features: ["Segurança Reforçada", "Agilidade e Conveniência", "Compliance", "Facilidade de Acesso"],
      color: "from-green-500 to-emerald-500"
    },
    {
      icon: "fas fa-rocket",
      title: "Abertura de Empresa",
      description: "Processo completo de abertura empresarial rápido, seguro e sem burocracia.",
      features: ["Consultoria gratuita", "Documentação completa", "Registro nos órgãos", "Suporte pós-abertura"],
      color: "from-purple-500 to-pink-500"
    },
    {
      icon: "fas fa-users",
      title: "Folha de Pagamento",
      description: "Gestão completa de funcionários, cálculos e todas as obrigações trabalhistas.",
      features: ["Cálculos automáticos", "Obrigações em dia", "Relatórios detalhados", "Suporte especializado"],
      color: "from-orange-500 to-red-500"
    },
    {
      icon: "fas fa-calculator",
      title: "Contabilidade e Auditoria",
      description: "Serviços contábeis completos e auditoria para manter sua empresa em conformidade.",
      features: ["Escrituração contábil", "Balanços e demonstrativos", "Auditoria interna", "Análise financeira"],
      color: "from-indigo-500 to-purple-500"
    },
    {
      icon: "fas fa-file-invoice-dollar",
      title: "Consultoria Fiscal",
      description: "Orientação especializada para otimização tributária e cumprimento das obrigações fiscais.",
      features: ["Planejamento tributário", "Revisão fiscal", "Recuperação de créditos", "Defesa fiscal"],
      color: "from-emerald-500 to-teal-500"
    },
    {
      icon: "fas fa-chart-line",
      title: "Planejamento Financeiro e Orçamentário",
      description: "Estratégias financeiras para crescimento sustentável e controle orçamentário eficiente.",
      features: ["Análise de viabilidade", "Orçamento empresarial", "Fluxo de caixa", "Projeções financeiras"],
  ...
  const steps = [
    ...
    },
    {
      number: "04",
      title: "Pronto!",
      description: "Cuidamos de toda a burocracia para você focar no seu negócio",
  ...
  const plans = [
    {
      name: "Endereço Fiscal Essencial",
      price: "97",
      period: "/mês",
      description: "Ideal para MEI e pequenos negócios",
      features: [
        "Endereço comercial estratégico",
        "IPTU comercial incluso",
    ...
    {
      name: "Endereço Fiscal Premium",
      price: "147",
      period: "/mês",
      description: "Para empresas que precisam de mais",
      features: [
        "Tudo do plano Essencial",
        "Licença sanitária inclusa",
        "Recebimento de correspondências",
        "Digitalização de documentos",
        "Atendimento prioritário",
        "Consultoria contábil mensal"
      ],
      highlighted: true,
      color: "from-green-500 to-emerald-500"
    },
  ...
  return (
    <>
      <Head>
        <title>WN Contabilidade - Especialistas em Endereço Fiscal e Certificados Digitais</title>
        <meta name="description" content="Descomplique sua vida empresarial com endereço fiscal confiável e certificados digitais. Especialistas em contabilidade empresarial." />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <Link href="#plans" className="text-gray-700 hover:text-blue-600 transition-colors font-medium">
                Planos
              </Link>
      ...
      <main>
          ...
          <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-white">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-xl md:text-2xl mb-8 opacity-90 leading-relaxed">
                ...
                <span className="text-yellow-300 font-semibold"> gastando muito menos!</span>
              </p>

              <p className="text-lg md:text-xl mb-8 opacity-90 max-w-3xl mx-auto leading-relaxed">
                Nós da WN Contabilidade, somos especialistas em Endereços Fiscais e Certificados Digitais, 
                traga a sua empresa até nós que iremos resolver todas questões contábeis e burocracias 
                para você com <strong className="text-yellow-300">profissionalismo e qualidade!</strong>
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
                ...
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                  ...
                  <div className="text-sm opacity-90">Documentação Regularizada</div>
                </div>
                <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl text-gray-600 max-w-3xl mx-auto">
                Soluções completas para profissionalizar sua empresa e manter tudo em conformidade
              </p>
            </div>
              ...
              <div>
                ...
                <div className="space-y-8">
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-800 mb-2">Experiência Comprovada</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Nossos especialistas contábeis têm vasta experiência em lidar com todos os aspectos, 
                        desde declarações fiscais até estratégias para o crescimento empresarial.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-800 mb-2">Transparência Total</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Valorizamos a transparência em tudo o que fazemos. Você pode confiar em nós 
                        para fornecer informações precisas e oportunas, mantendo você informado em cada etapa.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-800 mb-2">Atendimento Personalizado</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Reconhecemos que cada empresa é única. Oferecemos atendimento personalizado, 
                        trabalhando lado a lado para entender suas metas e fornecer soluções sob medida.
                      </p>
                    </div>
                  </div>
                  <div className="flex items-start space-x-4">
                    ...
                    <div>
                      <h4 className="text-xl font-bold text-gray-800 mb-2">Tecnologia de Ponta</h4>
                      <p className="text-gray-600 leading-relaxed">
                        Estamos na vanguarda da tecnologia contábil, utilizando as mais recentes 
                        ferramentas e softwares para otimizar processos e garantir máxima eficiência.
                      </p>
                    </div>
                  </div>
                </div>
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              ...
              <p className="text-xl opacity-90 max-w-3xl mx-auto">
                Processo simples e transparente para você profissionalizar sua empresa
              </p>
            </div>
                ...
                <div key={index} className="relative">
                  ...
                  {index < steps.length - 1 && (
                    <div className="hidden lg:block absolute top-1/2 -right-4 transform -translate-y-1/2">
                      <svg className="w-8 h-8 text-yellow-300 opacity-60" fill="currentColor" viewBox="0 0 20 20">
              ...
              {plans.map((plan, index) => (
                <div
                  ...
                  className={`relative bg-white rounded-3xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border ${
                    plan.highlighted 
                      ? 'border-green-200 shadow-green-100 ring-4 ring-green-100' 
                      : 'border-gray-100'
                  }`}
                >
                  {plan.highlighted && (
                    <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                      <span className="bg-gradient-to-r from-green-500 to-emerald-500 text-white px-6 py-2 rounded-full text-sm font-semibold shadow-lg">
                        Mais Popular
                      </span>
                    </div>
                  )}
                  <div className="text-center mb-8">
                    ...
                    <div className="flex items-baseline justify-center mb-6">
                      <span className="text-5xl font-bold text-gray-800">R$ {plan.price}</span>
        ...
        {/* Contact */}
        <section id="contact" className="py-20 bg-gradient-to-br from-blue-900 to-cyan-800 text-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h3 className="text-4xl md:text-5xl font-bold mb-6">
                Entre em Contato
              ...
              <p className="text-xl opacity-90 max-w-3xl mx-auto">
                Não importa o tamanho ou complexidade do seu negócio, estamos aqui para ajudar.
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    >
                      ...
                      <option value="Endereço Fiscal" className="text-gray-800">Endereço Fiscal</option>
                      <option value="Certificado Digital" className="text-gray-800">Certificado Digital</option>
                      <option value="Abertura de Empresa" className="text-gray-800">Abertura de Empresa</option>
                      <option value="Folha de Pagamento" className="text-gray-800">Folha de Pagamento</option>
                      <option value="Contabilidade e Auditoria" className="text-gray-800">Contabilidade e Auditoria</option>
                      <option value="Consultoria Fiscal" className="text-gray-800">Consultoria Fiscal</option>
                      <option value="Planejamento Financeiro e Orçamentário" className="text-gray-800">Planejamento Financeiro e Orçamentário</option>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Endereço Fiscal</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Certificado Digital</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Abertura de Empresa</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Folha de Pagamento</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Contabilidade e Auditoria</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Consultoria Fiscal</a></li>
                <li><a href="#services" className="text-gray-400 hover:text-white transition-colors">Planejamento Financeiro</a></li>
              </ul>
            </div>
            <div>
